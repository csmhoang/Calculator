...
{
    public static readonly double ViewHeight = DeviceDisplay.MainDisplayInfo.Height;
    public static readonly double ViewWidth = DeviceDisplay.MainDisplayInfo.Width;
